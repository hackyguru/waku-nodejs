...
import type { Callback, IBaseProtocolCore, IBaseProtocolSDK, ProtocolError, ProtocolUseOptions, SDKProtocolResult } from "./protocols.js";
...
export type IFilter = IReceiver & IBaseProtocolSDK & {
    ...
    subscribe<T extends IDecodedMessage>(decoders: IDecoder<T> | IDecoder<T>[], callback: Callback<T>, protocolUseOptions?: ProtocolUseOptions, subscribeOptions?: SubscribeOptions): Promise<SubscribeResult>;
};
...
export type CreateSubscriptionResult = ThisOrThat<"subscription", ISubscription, "error", ProtocolError>;
export {};
